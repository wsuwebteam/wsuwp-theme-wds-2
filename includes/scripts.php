...
class Scripts {
	...
	public static function enqueue_scripts() {
		...
		$wds_version   = ( ! empty( get_theme_mod( 'wsu_wds_theme_version' ) ) ) ? get_theme_mod( 'wsu_wds_theme_version' ) : '2.x';
		...
		$wsu_design_system_wordpress_css_path = '/dist/bundles/wsu-design-system.wordpress.css';
		...
		$wsu_design_system_wordpress_css      = $wsu_design_system_host . $wsu_design_system_wordpress_css_path;
		...
		wp_enqueue_style( 'wsu_design_system_wordpress_css', $wsu_design_system_wordpress_css, array(), $theme_version );
